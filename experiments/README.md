...
- [`car-palette-team-style-2k.png`](./by-input/car-palette-team-style-2k.md): start with `Balanced / 320 / 4 steps`. Representative run ID: `20260320_213504_car-palette-team-style-2k_balanced_s320_n4_bf16`
- [`delpmaspu-2k.png`](./by-input/delpmaspu-2k.md): start with `Balanced / 320 / 4 steps`. Representative run ID: `20260320_214442_delpmaspu-2k_balanced_s320_n4_bf16`
- [`grok-image-square.png`](./by-input/grok-image-square.md): start with `Balanced / 320 / 4 steps`. Representative run ID: `20260320_215508_grok-image-square_balanced_s320_n4_bf16`
- [`kling-generate-square.png`](./by-input/kling-generate-square.md): start with `Balanced / 256 / 4 steps`. Representative run ID: `20260320_220259_kling-generate-square_balanced_s256_n4_bf16`
